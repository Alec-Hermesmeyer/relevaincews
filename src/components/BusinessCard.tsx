...
return (
  <div className="min-h-screen flex items-center justify-center bg-black">
    <div
      className="p-8 mx-2 border rounded-lg shadow-lg max-w-sm w-80 h-[65vh] text-center text-white relative bg-[#10275E] overflow-hidden"
      style={{
    ...
    >
      <Image
        ...
        className=""
      />
      <div className="p-6 rounded-md z-auto absolute bottom-20 left-1 right-1">
        <h2 className="mt-6 text-5xl font-extrabold text-right mb-2 font-roboto">
          {name}
        </h2>
