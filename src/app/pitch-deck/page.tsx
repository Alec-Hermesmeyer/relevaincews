          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="text-center space-y-6">
              ...
              <p className="text-lg leading-relaxed">
                AI agents that do more than generate documents. Human-like reasoning, which allows the user{" "}
                <span className="underline">obtain</span> a true picture of facts, themes, strengths, and weakness. Find
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-1">Ishar Jain</h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center space-y-8 mb-16">
            <h2 className="text-4xl md:text-6xl font-bold">
              You Are Invited <span className="underline">To</span> Join Us
            </h2>
            <p className="text-xl md:text-2xl max-w-4xl mx-auto">
              Join us in revolutionizing reasoning across scale! Book a meeting to explore investment opportunities with{" "}
              <span className="underline">Relevaince</span>.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 mb-32">
            ...
            <Link href="/" className="text-2xl font-semibold hover:text-blue-400 transition-colors">
              Visit our <span className="underline">Website</span>
            </Link>
          </div>
